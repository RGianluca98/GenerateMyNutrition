...
const FOOD_DB = {
  protein_equiv_chicken:[
    {name:'Petto di pollo',        qty:Q(160,220), uom:'g', kcal:110, limitKey:'white_meat_fresh'},
    {name:'Merluzzo',              qty:Q(200,220), uom:'g', kcal:82,  limitKey:'fish_fresh'},
    {name:'Salmone',               qty:Q(200,220), uom:'g', kcal:208, limitKey:'fish_fresh'},
    ...
    {name:'Tonno al naturale',     qty:Q(100,130), uom:'g', kcal:116, limitKey:'tuna_canned'},
    ...
    {name:'Uova',                  qty:Q(120,150), uom:'g', kcal:143, limitKey:'eggs'},
    ...
    {name:'Lenticchie cotte',      qty:Q(160,250), uom:'g', kcal:116, limitKey:'legumes_cooked'},
    ...
    {name:'Ricotta',               qty:Q(150,220), uom:'g', kcal:174, limitKey:'fresh_cheese'},
    ...
    {name:'Yogurt greco',          qty:Q(200,200), uom:'g', kcal:59,  limitKey:'yogurt_skyr'},
  ],
  lunch_carb_pasta:[
    {name:'Pasta integrale', qty:Q(110,110), uom:'g', kcal:356, limitKey:'pasta_family'},
    ...
    {name:'Riso',            qty:Q(110,130), uom:'g', kcal:360, limitKey:'rice_family'},
    {name:'Riso basmati',    qty:Q(110,130), uom:'g', kcal:360, limitKey:'rice_family'},
    {name:'Riso jasmine',    qty:Q(110,130), uom:'g', kcal:360, limitKey:'rice_family'},
  ...
  dinner_carb_bread:[
    {name:'Pane integrale',    qty:Q(90,90),  uom:'g', kcal:224, limitKey:'bread_family'},
    ...
    {name:'Patate',            qty:Q(220,260),uom:'g', kcal:77,  limitKey:'potato_family'},
    {name:'Patate dolci',      qty:Q(220,260),uom:'g', kcal:86,  limitKey:'potato_family'},
    {name:'Pure di patate',    qty:Q(220,260),uom:'g', kcal:83,  limitKey:'pure_family'},
  ...
  oats_breakfast:[
    {name:'Avena',                     qty:Q(60,70), uom:'g',  kcal:379, limitKey:'oats_family'},
    {name:'Muesli',                    qty:Q(60,60), uom:'g',  kcal:363, limitKey:'oats_family'},
    {name:'Fette biscottate integrali',qty:Q(4,5),   uom:'pz', kcal:38,  limitKey:'fette_family'},
    {name:'Gallette di mais',          qty:Q(8.75,8.75), uom:'pz', kcal:38, limitKey:'gallette_family'},
  ],
  milk_portion:[
  ...
  fruit_portion:[
    ...
    {name:'Mirtilli',      qty:Q(150,200),uom:'g',    kcal:57,  limitKey:'fruit_portion'},
  ...
  yogurt_portion:[
    {name:'Skyr',        qty:Q(170,200),uom:'g',kcal:63, limitKey:'yogurt_skyr'},
    {name:'Yogurt greco',qty:Q(200,200),uom:'g',kcal:59, limitKey:'yogurt_skyr'},
  ],
  nuts_snack:[
    {name:'Mandorle',          qty:Q(20,20),uom:'g',kcal:579, limitKey:'nuts'},
    {name:'Noci',              qty:Q(20,30),uom:'g',kcal:654, limitKey:'nuts'},
...
FOOD_DB.free_meal_dinner = [
  {name:'Pizza 🍕 (pasto libero)',      qty:Q(1,1), uom:'porz', kcal:800, limitKey:null},
...
FOOD_DB.breakfast_protein = [
  ...
  {name:'Latte di riso',         qty:Q(200,300), uom:'ml', kcal:47,  limitKey:'milk_default'},
...
FOOD_DB.breakfast_toppings = [
  {name:'Burro di arachidi',  qty:Q(20,20), uom:'g', kcal:588, limitKey:'pb'},
  {name:'Nocciole',           qty:Q(15,25), uom:'g', kcal:628, limitKey:'nuts'},
