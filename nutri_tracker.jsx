...
const FOOD_DB = {
  protein_equiv_chicken:[
    {name:'Petto di pollo',        qty:Q(220,200), uom:'g', kcal:110, limitKey:'white_meat_fresh'},
    ...
    {name:'Tonno al naturale',     qty:Q(130,120), uom:'g', kcal:116, limitKey:'tuna_canned'},
    ...
    {name:'Uova',                  qty:Q(150,120), uom:'g', kcal:143, limitKey:'eggs'},
    ...
    {name:'Lenticchie cotte',      qty:Q(250,180), uom:'g', kcal:116, limitKey:'legumes_cooked'},
    ...
    {name:'Ricotta',               qty:Q(220,200), uom:'g', kcal:174, limitKey:'fresh_cheese'},
  ...
  dinner_carb_bread:[
    ...
    {name:'Patate',            qty:Q(260,250),uom:'g', kcal:77,  limitKey:'potato_family'},
    {name:'Patate dolci',      qty:Q(260,250),uom:'g', kcal:86,  limitKey:'potato_family'},
    {name:'Pure di patate',    qty:Q(260,250),uom:'g', kcal:83,  limitKey:'pure_family'},
  ...
  oats_breakfast:[
    {name:'Avena',                     qty:Q(70,60), uom:'g',  kcal:379, limitKey:'oats_family'},
    {name:'Muesli',                    qty:Q(60,60), uom:'g',  kcal:363, limitKey:'oats_family'},
    {name:'Fette biscottate integrali',qty:Q(5,4),   uom:'pz', kcal:38,  limitKey:'fette_family'},
    {name:'Gallette di mais',          qty:Q(8.75,8.75), uom:'pz', kcal:38, limitKey:'gallette_family'},
  ],
  milk_portion:[
  ...
  fruit_portion:[
    ...
    {name:'Mirtilli',      qty:Q(200,150),uom:'g',    kcal:57,  limitKey:'fruit_portion'},
  ...
  yogurt_portion:[
    {name:'Skyr',        qty:Q(200,170),uom:'g',kcal:63, limitKey:'yogurt_skyr'},
    {name:'Yogurt greco',qty:Q(200,200),uom:'g',kcal:59, limitKey:'yogurt_skyr'},
  ],
  nuts_snack:[
    {name:'Mandorle',          qty:Q(20,20),uom:'g',kcal:579, limitKey:'nuts'},
    {name:'Noci',              qty:Q(30,20),uom:'g',kcal:654, limitKey:'nuts'},
...
FOOD_DB.breakfast_protein = [
  ...
  {name:'Latte di riso',         qty:Q(300,250), uom:'ml', kcal:47,  limitKey:'milk_default'},
...
FOOD_DB.breakfast_toppings = [
  {name:'Burro di arachidi',  qty:Q(20,20), uom:'g', kcal:588, limitKey:'pb'},
  {name:'Nocciole',           qty:Q(25,15), uom:'g', kcal:628, limitKey:'nuts'},
